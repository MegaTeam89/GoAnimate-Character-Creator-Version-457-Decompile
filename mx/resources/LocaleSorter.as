...
class LocaleID
{
   ...
   public function toString() : String
   {
      ...
      Array.prototype.push.apply(_loc1_,extended_langs);
      if(script != "")
      {
         _loc1_.push(script);
      }
      ...
      Array.prototype.push.apply(_loc1_,variants);
      for(_loc2_ in extensions)
      {
         if(extensions.hasOwnProperty(_loc2_))
         {
            _loc1_.push(_loc2_);
            Array.prototype.push.apply(_loc1_,extensions[_loc2_]);
         }
      }
      if(privates.length > 0)
      {
         _loc1_.push("x");
         Array.prototype.push.apply(_loc1_,privates);
      }
