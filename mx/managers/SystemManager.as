package mx.managers
{
   ...
   public class SystemManager extends MovieClip implements IChildList, IFlexDisplayObject, IFlexModuleFactory, ISystemManager, ISWFBridgeProvider
   {
      ...
      private function removeEventListenerFromSandboxes(param1:String, param2:Function, param3:Boolean = false, param4:IEventDispatcher = null) : void
      {
         ...
         if((_loc6_ = swfBridgeGroup.parentBridge) && _loc6_ != param4)
         {
      ...
      mx_internal function addingChild(param1:DisplayObject) : void
      {
         ...
         var _loc2_:int = 1;
         if(!mx_internal::topLevel && parent)
         {
      ...
      public function get embeddedFontList() : Object
      {
         ...
         if(_fontList == null)
         {
            ...
            if(!mx_internal::topLevel && _topLevelSystemManager)
            {
      ...
      {
         if(!mx_internal::topLevel && topLevelSystemManager)
         {
      ...
      private function mouseDownHandler(param1:MouseEvent) : void
      {
         ...
         if(_loc2_ && mx_internal::bridgeToFocusManager[_loc2_] == document.focusManager)
         {
            if(isTopLevelRoot())
            {
               activateForm(document);
      ...
      mx_internal function docFrameHandler(param1:Event = null) : void
      {
         ...
         if(_loc3_ && _loc3_.length > 0)
         {
            ...
            while(_loc5_ < _loc4_)
            {
               (_loc6_ = Class(getDefinitionByName(_loc3_[_loc5_])))["init"](this);
               _loc5_++;
            }
         }
      ...
      {
         return !!mx_internal::topLevelWindow ? Number(mx_internal::topLevelWindow.getExplicitOrMeasuredWidth()) : Number(loaderInfo.width);
      }
      ...
      {
         ++noTopMostIndex;
         return rawChildren_addChildAt(param1,mx_internal::applicationIndex + param2);
      }
      ...
      public function dispatchEventFromSWFBridges(param1:Event, param2:IEventDispatcher = null, param3:Boolean = false, param4:Boolean = false) : void
      {
         ...
         var _loc6_:IEventDispatcher;
         if((_loc6_ = swfBridgeGroup.parentBridge) && _loc6_ != param2)
         {
      ...
      private function addEventListenerToSandboxes(param1:String, param2:Function, param3:Boolean = false, param4:int = 0, param5:Boolean = false, param6:IEventDispatcher = null) : void
      {
         ...
         if((_loc8_ = swfBridgeGroup.parentBridge) && _loc8_ != param6)
         {
      ...
      {
         ++noTopMostIndex;
         return rawChildren_addChildAt(param1,mx_internal::noTopMostIndex - 1);
      }
      ...
      {
         --noTopMostIndex;
         return rawChildren_removeChildAt(mx_internal::applicationIndex + param1);
      }
      ...
      {
         return !!mx_internal::topLevelWindow ? Number(mx_internal::topLevelWindow.getExplicitOrMeasuredHeight()) : Number(loaderInfo.height);
      }
      ...
      mx_internal function initialize() : void
      {
         ...
         var _loc10_:String;
         if((_loc10_ = loaderInfo.parameters["localeChain"]) != null && _loc10_ != "")
         {
            _loc8_.localeChain = _loc10_.split(",");
         }
         var _loc11_:String;
         var _loc12_:Array = !!(_loc11_ = loaderInfo.parameters["resourceModuleURLs"]) ? _loc11_.split(",") : null;
      ...
      private function initializeTopLevelWindow(param1:Event) : void
      {
         ...
         if(!mx_internal::topLevel)
         {
            ...
            while(_loc3_)
            {
               ...
               {
                  if((_loc4_ = IUIComponent(_loc3_).systemManager) && !_loc4_.isTopLevel())
                  {
         ...
         else if(mx_internal::topLevel && stage)
         {
